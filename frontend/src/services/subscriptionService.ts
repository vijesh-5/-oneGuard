import { Subscription, SubscriptionCreate, SubscriptionConfirmResponse } from '../types/subscription';
import api from './api';
...
const SubscriptionService = {
    ...
    confirm: async (subscriptionId: number): Promise<SubscriptionConfirmResponse> => {
        return (await api.patch(`/subscriptions/${subscriptionId}/confirm`)).data;
    }
};
